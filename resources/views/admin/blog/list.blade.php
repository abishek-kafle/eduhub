            ...
            <form method="POST" action="blog">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="message-text" name="author">
                  </div>
            ...
            <tbody>
                    @foreach ($blogs as $blog)
                        <tr>
                            ...
                            <td>{{$blog->author}}</td>
                            <td><a href="blog/{{$blog->id}}/edit" class="btn btn-primary"><i class="fa fa-edit"></i></a></td>
                            <td>
                                <form action="{{action('App\Http\Controllers\Admin\BlogController@destroy',$blog->id)}}" method="POST">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE')}}
